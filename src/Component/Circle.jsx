  ...
  return (
    <>
      <div className="circle z-0">
        <div className="py-24 flex space-x-[340px]">
          <div className="w-[276px] h-[276px] rounded-full border-[10px] opacity-60 border-opacity-50 translate-x-70  border-[#FFFFFF1A]" />
          ...
          <div className="w-[59px] h-[59px] mt-[-6%] bg-pink-600 rounded-full border-4 opacity-60 border-pink-600" />
        </div>
        ...
        <div className="w-[276px] h-[276px] rounded-full  opacity-60 border-opacity-50 ml-[80%] top-[60%] border-[#FFFFFF1A] border-[10px]" />
