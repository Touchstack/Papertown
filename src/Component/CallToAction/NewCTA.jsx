...
const NewCTA = () => {
  return (
    <div className="mt-[6rem] flex flex-col items-center ">
      <a className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 grid-cols-1 bg-white  border border-gray-200 rounded-[50px] shadow md:flex-row xl:w-8/12 lg:w-9/12 md:w-10/12 ">
        <div className="flex flex-col justify-between leading-normal lg:px-[60px] xl:px-[100px] px-4 lg:py-20 md:py-12 sm:p-8 py-8 lg:rounded-l-[50px] lg:rounded-tr-none  md:rounded-t-[50px] sm:rounded-t-[50px] rounded-t-[50px]">
          ...
          <p className="mb-3 font-normal text-gray-700 ">
            Papertown Imaginarium was selected as one of the beneficiaries of the Tony Elumelu Foundation
            (TEF) Entrepreneurship Forum 2018. The funding and training we received through the programme
            helped fuel our dream and make us the existing entity we are today.
            We are grateful that the Foundation took a chance on us and we aim to continuously make them
            proud with all that we do and accomplish.
          </p>
          <button
