    ...
    <div className="translate-y-2 w-[139.53px] h-[34.50px] justify-start items-center gap-2 inline-flex mb-6 py-4">
      ...
      <div className="">
        <span className="inline-block transform translate-y-[-5]">
          ...
          />
          <div className=" h-[34.50px] px-[14.21px] bg-white bg-opacity-40 rounded-full border-2 border-emerald-400 justify-start items-start gap-[20.29px] flex overflow-hidden" />
        </span>
      </div>{" "}
    </div>
  );
