...
const GeneralNav = ({ color, btnColor, bgColor, bgShadow }) => {
  ...
  return (
    <>
      <nav
        className={`flex container mx-auto px-2 text-center font-Regular rounded-full max-w-6xl lg:pt-2 md:pt-2 sm:px-4 py-3 ${bgColorClass} ${shadowClass}`}
      >
        <div className="container md:pl-25 flex justify-between items-center m-auto">
          ...
          >
            <path
              d="M3.83301 12.6248H21.833M3.83301 6.62476H21.833M9.83301 18.6248H21.833"
              stroke="black"
              strokeWidth="3"
              strokeLinecap="round"
