...
const Readpage = () => {
  return (
    <div
      className="bg-custom-gradient bg-no-repeat lg:bg-cover md:h-[722px] h-[500px]"
    ...
    >
      ...
      <div className="flex flex-row justify-center mt-[7%] items-center">
        ...
        <div className="w-[569.61px] h-[235.611px] justify-center rotate-[10deg] bg-custom-prm rounded-[90.62px] overflow-hidden hidden md:block relative">
          <p className="text-[#e0b9e2] absolute z-10 left-[105px] lg:top-[-5px] md:text-[50px] lg:text-[72px] font-Bold">
            my writing
          </p>
          <img
            src={readSplash}
            alt=""
            className="absolute z-20 left-10 w-[450px] bottom-[-4rem]"
          />
        </div>
        {/*Righ*/}
      </div>
