  ...
  return (
    <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 grid-cols-1 gap-80 justify-between items-between mt-12">
      ...
      <div className="md:mt-0 sm:mt-16 mt-16 ">
        <div className="font-Regular text-[#6D6D6D] text-xl lg:text-xl md:text-lg sm:text-lg lg:text-left md:text-left text-center max-w-[3000px]">
          <h3 className="font-Bold lg:text-xl md:text-xl sm:text-xl text-xl lg:text-left text-center text-[#000000] ">
            <span className="inline-flex gap-2">
              <img
                style={{ height: "auto" }}
          ...
          <div>
            <h3 className="font-Bold mt-10 lg:text-left text-center text-[#000000]">
              <span className="inline-flex gap-2 ">
                <img
                  style={{ height: "auto" }}
                  src={Meeting}
