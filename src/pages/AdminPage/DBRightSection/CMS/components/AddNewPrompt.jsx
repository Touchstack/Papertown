        ...
        <IoCloseSharp color='#000' onClick={handleClose} cursor={'pointer'} />
          ...
          <div className='flex flex-col'>
            ...
            <div className='flex flex-col mt-2'>
              <label htmlFor="grade" className="text-lg font-medium text-gray-800">
                Eligible grades
              </label>
              <input
            ...
            <div className='flex flex-col mt-2'>
              <label htmlFor="submissionGuidelines" className="text-lg font-medium text-gray-800">
                Submission Guidelines
              </label>
              <textarea
                {...register("submissionGuidelines", { required: "Submission guidelines are required" })}
                id="submissionGuidelines"
                name="submissionGuidelines"
                placeholder="Enter submission guidelines"
                className="mt-1 p-3 w-full bg-[#EFF3F4] border border-gray-300 rounded-[10px] outline-none focus:border-none"
              />
              {errors.submissionGuidelines && <p className="text-red-500 text-sm mt-2">{errors.submissionGuidelines.message}</p>}
            </div>
            ...
            <div className='flex flex-col mt-2'>
              ...
              <input
                ...
                className="mt-1 p-3 w-full bg-[#EFF3F4] border border-gray-300 rounded-[10px] outline-none focus:border-none"
              />
              {errors.resources && <p className="text-red-500 text-sm mt-2">{errors.resources.message}</p>}
            </div>

            {/* Submit button */}
            <button type="submit" className="mt-5 bg-[#DF327B] w-[100%] h-[54px] font-[700] text-white rounded-[50px] px-5" disabled={isSubmitting}>
            {loading ? (
