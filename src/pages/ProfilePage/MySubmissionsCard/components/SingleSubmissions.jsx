  ...
  return (
    <>
      {!viewReview ? (
        <div className="bg-white shadow-xl lg:p-10 p-5 md:p-10 rounded-xl lg:w-[973px]  w-[90vw]" >
          ...
          <div className="space-y-5 p-4">
            ...
            <p>
              ...
              passages, and more recently with desktop publishing software. It
          ...
          <div className="p-4">
            <div className="flex flex-col gap-y-4 custom-497:flex-row custom-497:items-center justify-between">
              ...
              <div className="text-[#52B4AE] flex flex-col gap-y-2 custom-497:flex-row custom-497:items-center gap-x-4 font-SemiBold ">
                <p onClick={handleViewReview} className="cursor-pointer">
                  View all (3) revisions
                </p>
                <button className="py-2 px-4 border border-[#52B4AE] rounded-[30px]">
                  Submit revision
                </button>
              </div>
            </div>
       ...
       <RevisionList onBackClick={setViewReview}/>
      )}
    </>
  );
};
