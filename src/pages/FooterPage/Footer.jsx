...
>>>>>>> 601139d (fixed responsive drop-down and nav bar color apdation)
        <div className="md:flex md:justify-center p-4">
          <div className="grid lg:grid-cols-6 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 gap-8 sm:gap-6">
            <div className="">
              ...
              <div className="font-Regular text-[#D0D0D0] mt-6 text-sm sm:text-start">
                Quick Links
              </div>
              ...
              >
                ...
                <span className="text-[#FFF] text-lg font-Bold">FAQs</span>
                <span className="text-[#FFF] text-lg font-Bold">
                  Contact Us
                </span>
              </div>
