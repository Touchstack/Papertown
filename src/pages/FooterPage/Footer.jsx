                  ...
                  <form name="subscribe" method="post">
                    ...
                    {loading ? null : (
                      <button
                        ...
                        className="font-SemiBold text-[#FFFFFF] bg-[#52B4AE] block md:w-[300px] h-14 p-4 hover:bg-amber-400 focus:ring-1 focus:outline-none focus:ring-amber-100 font-medium rounded-full text-xl px-5 py-3 text-center mr-3 md:mr-0"
                      >
                        Subscribe
                      </button>
                    )}
